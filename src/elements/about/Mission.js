                ...
                <div className="row row--30">
                    <div className="col-lg-6">
                        <div className="mission-title">
                            ...
                            <p>Etra Bio is a biotech startup that is dedicated to bridging the gap between early-stage research and development of cures and successful clinical treatments. We believe that the use of cutting-edge technology and innovative internal tools will enable us to fast-track the process of getting a product to the clinic and improve the lives of patients everywhere. </p>

                            <p>Etra Bio was founded by three passionate clinical trial experts who saw a need for a more streamlined approach to getting life-saving treatments to patients. Our team of experts has years of experience in the clinical trial industry and a deep understanding of the complex regulatory landscape. We use this expertise to help our clients navigate the development process, from early-stage research to FDA approval and beyond. </p>
