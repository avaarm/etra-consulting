    ...
    return (
        <>
            ...
            <main className="page-wrapper">
                ...
                {/* End Slider Area  */}
{/* development - clinical grade process, r&d improvements, equipment surveys */}
{/* bench to bedside implementation  */}
{/* thorough review of equip and materials  */}
{/* process design for clinical scale manufacturing */}
{/* help reduce time & cost required for clinincal implementation */}
{/* FDA communication 
Cost Analysis  */}
                <Separator />
